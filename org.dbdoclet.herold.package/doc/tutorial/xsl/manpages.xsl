<xsl:stylesheet exclude-result-prefixes="#default" version="1.0" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:param name="admon.graphics.path">file:/C:/Program%20Files%20(x86)/DocBook%20Doclet/docbook/xsl/images/</xsl:param>
  ...
  <xsl:param name="callout.graphics.path">file:/C:/Program%20Files%20(x86)/DocBook%20Doclet/docbook/xsl/images/callouts/</xsl:param>
