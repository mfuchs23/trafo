-injars build/herold.jar
-outjars build/herold-pg.jar

-libraryjars /usr/local/java/j2sdk1.4.2/jre/lib/rt.jar
-libraryjars /usr/local/java/apache-ant-1.7.0/lib/ant.jar
